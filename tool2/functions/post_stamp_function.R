#################################### function to create post stamp plot QPC #######################
### Input is data_overviews_test_n2b & data_overviews_test_customer 
### Only country is selected in markdown

post_stamp_function <- function(x)  {
